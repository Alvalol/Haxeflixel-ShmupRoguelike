...
@:keep @:bind #if display private #end class __ASSET__assets_images_player_pyxel extends null { }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_solidtiles_pyxel extends null { }
