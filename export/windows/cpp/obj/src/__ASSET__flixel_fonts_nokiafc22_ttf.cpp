...
{
HX_STACK_FRAME("__ASSET__flixel_fonts_nokiafc22_ttf","new",0x22f03f2a,"__ASSET__flixel_fonts_nokiafc22_ttf.new","DefaultAssetLibrary.hx",531,0x0fc48912)
HX_STACK_THIS(this)
...
{
	resourceName= HX_HCSTRING("NME_font___ASSET__flixel_fonts_nokiafc22_ttf","\x01","\x0c","\xd5","\x08");
}
