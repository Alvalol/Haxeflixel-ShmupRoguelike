...
{
HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","new",0x2ea82fd5,"flixel.ui.FlxTypedButton_flixel_text_FlxText.new","flixel/ui/FlxButton.hx",116,0xc64cf442)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","graphicLoaded",0x64e8a882,"flixel.ui.FlxTypedButton_flixel_text_FlxText.graphicLoaded","flixel/ui/FlxButton.hx",233,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_LINE(234)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","loadDefaultGraphic",0x7b7964d8,"flixel.ui.FlxTypedButton_flixel_text_FlxText.loadDefaultGraphic","flixel/ui/FlxButton.hx",243,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_LINE(243)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","setupAnimation",0x57260372,"flixel.ui.FlxTypedButton_flixel_text_FlxText.setupAnimation","flixel/ui/FlxButton.hx",247,0xc64cf442)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","destroy",0x7bd7eaef,"flixel.ui.FlxTypedButton_flixel_text_FlxText.destroy","flixel/ui/FlxButton.hx",257,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_LINE(258)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","update",0x1dcc7db4,"flixel.ui.FlxTypedButton_flixel_text_FlxText.update","flixel/ui/FlxButton.hx",283,0xc64cf442)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","updateStatusAnimation",0xca93861e,"flixel.ui.FlxTypedButton_flixel_text_FlxText.updateStatusAnimation","flixel/ui/FlxButton.hx",305,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_LINE(306)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","draw",0x9def52ef,"flixel.ui.FlxTypedButton_flixel_text_FlxText.draw","flixel/ui/FlxButton.hx",313,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_LINE(314)
		this->super::draw();
		HX_STACK_LINE(316)
...
bool FlxTypedButton_flixel_text_FlxText_obj::stampOnAtlas( ::flixel::graphics::atlas::FlxAtlas atlas){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","stampOnAtlas",0x16f683d4,"flixel.ui.FlxTypedButton_flixel_text_FlxText.stampOnAtlas","flixel/ui/FlxButton.hx",347,0xc64cf442)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","updateButton",0xc55492c6,"flixel.ui.FlxTypedButton_flixel_text_FlxText.updateButton","flixel/ui/FlxButton.hx",378,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_LINE(380)
...
bool FlxTypedButton_flixel_text_FlxText_obj::checkMouseOverlap( ){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","checkMouseOverlap",0xab0126ff,"flixel.ui.FlxTypedButton_flixel_text_FlxText.checkMouseOverlap","flixel/ui/FlxButton.hx",399,0xc64cf442)
	HX_STACK_THIS(this)
	HX_STACK_LINE(401)
	{
		HX_STACK_LINE(401)
...
bool FlxTypedButton_flixel_text_FlxText_obj::checkTouchOverlap( ){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","checkTouchOverlap",0xf3bdeca5,"flixel.ui.FlxTypedButton_flixel_text_FlxText.checkTouchOverlap","flixel/ui/FlxButton.hx",432,0xc64cf442)
	HX_STACK_THIS(this)
	HX_STACK_LINE(432)
	return false;
}
...
bool FlxTypedButton_flixel_text_FlxText_obj::checkInput( ::flixel::input::FlxPointer pointer,::flixel::input::IFlxInput input,::flixel::math::FlxPoint justPressedPosition,::flixel::FlxCamera camera){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","checkInput",0xaea16f4d,"flixel.ui.FlxTypedButton_flixel_text_FlxText.checkInput","flixel/ui/FlxButton.hx",436,0xc64cf442)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","updateStatus",0xf1701806,"flixel.ui.FlxTypedButton_flixel_text_FlxText.updateStatus","flixel/ui/FlxButton.hx",456,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_ARG(input,"input")
		HX_STACK_LINE(457)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","updateLabelPosition",0x2a00d069,"flixel.ui.FlxTypedButton_flixel_text_FlxText.updateLabelPosition","flixel/ui/FlxButton.hx",477,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_LINE(478)
		::flixel::FlxSprite tmp = this->_spriteLabel;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(478)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","updateLabelAlpha",0x3fb91f9e,"flixel.ui.FlxTypedButton_flixel_text_FlxText.updateLabelAlpha","flixel/ui/FlxButton.hx",486,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_LINE(487)
		::flixel::FlxSprite tmp = this->_spriteLabel;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(487)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","onUpEventListener",0xcc8c5f29,"flixel.ui.FlxTypedButton_flixel_text_FlxText.onUpEventListener","flixel/ui/FlxButton.hx",499,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_,"_")
		HX_STACK_LINE(500)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","onUpHandler",0x44710205,"flixel.ui.FlxTypedButton_flixel_text_FlxText.onUpHandler","flixel/ui/FlxButton.hx",511,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_LINE(512)
		this->set_status((int)0);
		HX_STACK_LINE(513)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","onDownHandler",0x1de9d05e,"flixel.ui.FlxTypedButton_flixel_text_FlxText.onDownHandler","flixel/ui/FlxButton.hx",523,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_LINE(524)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","onOverHandler",0xf95219ac,"flixel.ui.FlxTypedButton_flixel_text_FlxText.onOverHandler","flixel/ui/FlxButton.hx",534,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_LINE(535)
...
{
		HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","onOutHandler",0x8a95b0c6,"flixel.ui.FlxTypedButton_flixel_text_FlxText.onOutHandler","flixel/ui/FlxButton.hx",544,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_LINE(545)
		this->set_status((int)0);
		HX_STACK_LINE(546)
...
::flixel::text::FlxText FlxTypedButton_flixel_text_FlxText_obj::set_label( ::flixel::text::FlxText Value){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","set_label",0xb45e3b8c,"flixel.ui.FlxTypedButton_flixel_text_FlxText.set_label","flixel/ui/FlxButton.hx",552,0xc64cf442)
	HX_STACK_THIS(this)
...
int FlxTypedButton_flixel_text_FlxText_obj::set_status( int Value){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","set_status",0xda949e9a,"flixel.ui.FlxTypedButton_flixel_text_FlxText.set_status","flixel/ui/FlxButton.hx",569,0xc64cf442)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Value,"Value")
	HX_STACK_LINE(570)
	this->status = Value;
...
Float FlxTypedButton_flixel_text_FlxText_obj::set_alpha( Float Value){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","set_alpha",0x6645d4f6,"flixel.ui.FlxTypedButton_flixel_text_FlxText.set_alpha","flixel/ui/FlxButton.hx",576,0xc64cf442)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Value,"Value")
	HX_STACK_LINE(577)
...
Float FlxTypedButton_flixel_text_FlxText_obj::set_x( Float Value){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","set_x",0x2df28210,"flixel.ui.FlxTypedButton_flixel_text_FlxText.set_x","flixel/ui/FlxButton.hx",583,0xc64cf442)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Value,"Value")
	HX_STACK_LINE(584)
	Float tmp = Value;		HX_STACK_VAR(tmp,"tmp");
...
Float FlxTypedButton_flixel_text_FlxText_obj::set_y( Float Value){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","set_y",0x2df28211,"flixel.ui.FlxTypedButton_flixel_text_FlxText.set_y","flixel/ui/FlxButton.hx",590,0xc64cf442)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Value,"Value")
	HX_STACK_LINE(591)
	Float tmp = Value;		HX_STACK_VAR(tmp,"tmp");
...
bool FlxTypedButton_flixel_text_FlxText_obj::get_justReleased( ){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","get_justReleased",0x234d62fd,"flixel.ui.FlxTypedButton_flixel_text_FlxText.get_justReleased","flixel/ui/FlxButton.hx",597,0xc64cf442)
	HX_STACK_THIS(this)
	HX_STACK_LINE(598)
	::flixel::input::FlxInput tmp = this->input;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(598)
...
bool FlxTypedButton_flixel_text_FlxText_obj::get_released( ){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","get_released",0x17b1c6b1,"flixel.ui.FlxTypedButton_flixel_text_FlxText.get_released","flixel/ui/FlxButton.hx",602,0xc64cf442)
	HX_STACK_THIS(this)
	HX_STACK_LINE(603)
...
bool FlxTypedButton_flixel_text_FlxText_obj::get_pressed( ){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","get_pressed",0x60818f2e,"flixel.ui.FlxTypedButton_flixel_text_FlxText.get_pressed","flixel/ui/FlxButton.hx",607,0xc64cf442)
	HX_STACK_THIS(this)
	HX_STACK_LINE(608)
	bool tmp;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(608)
...
bool FlxTypedButton_flixel_text_FlxText_obj::get_justPressed( ){
	HX_STACK_FRAME("flixel.ui.FlxTypedButton_flixel_text_FlxText","get_justPressed",0x5f690062,"flixel.ui.FlxTypedButton_flixel_text_FlxText.get_justPressed","flixel/ui/FlxButton.hx",612,0xc64cf442)
	HX_STACK_THIS(this)
	HX_STACK_LINE(613)
	::flixel::input::FlxInput tmp = this->input;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(613)
