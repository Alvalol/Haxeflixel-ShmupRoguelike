...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(2078)
	::String tmp4 = ::flixel::tile::GraphicAutoAlt_obj::resourceName;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(2078)
...
{  hx::ObjectPtr< GraphicAutoAlt_obj > _result_ = new GraphicAutoAlt_obj();
...
{
	resourceName= HX_HCSTRING("__ASSET__:bitmap_flixel_tile_GraphicAutoAlt","\xc6","\x25","\x2e","\x70");
}
