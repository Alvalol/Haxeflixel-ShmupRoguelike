...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(2078)
	::String tmp4 = ::flixel::_system::GraphicLogo_obj::resourceName;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(2078)
...
{  hx::ObjectPtr< GraphicLogo_obj > _result_ = new GraphicLogo_obj();
...
{
	resourceName= HX_HCSTRING("__ASSET__:bitmap_flixel_system_GraphicLogo","\xa0","\xbd","\xf5","\x14");
}
