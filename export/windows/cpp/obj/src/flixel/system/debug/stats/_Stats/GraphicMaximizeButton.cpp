...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(2078)
	::String tmp4 = ::flixel::_system::debug::stats::_Stats::GraphicMaximizeButton_obj::resourceName;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(2078)
...
{  hx::ObjectPtr< GraphicMaximizeButton_obj > _result_ = new GraphicMaximizeButton_obj();
...
{
	resourceName= HX_HCSTRING("__ASSET__:bitmap_flixel_system_debug_stats__Stats_GraphicMaximizeButton","\x66","\x7c","\xbc","\xb9");
}
