...
{
HX_STACK_FRAME("flixel.system.debug._VCR.GraphicOpen","new",0x5cfdc604,"flixel.system.debug._VCR.GraphicOpen.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
HX_STACK_THIS(this)
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(2078)
	::String tmp4 = ::flixel::_system::debug::_VCR::GraphicOpen_obj::resourceName;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(2078)
...
{  hx::ObjectPtr< GraphicOpen_obj > _result_ = new GraphicOpen_obj();
...
{
	resourceName= HX_HCSTRING("__ASSET__:bitmap_flixel_system_debug__VCR_GraphicOpen","\x38","\xbb","\xf9","\x19");
}
