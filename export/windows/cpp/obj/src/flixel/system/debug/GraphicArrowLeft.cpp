...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(2078)
	::String tmp4 = ::flixel::_system::debug::GraphicArrowLeft_obj::resourceName;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(2078)
...
{  hx::ObjectPtr< GraphicArrowLeft_obj > _result_ = new GraphicArrowLeft_obj();
...
{
	resourceName= HX_HCSTRING("__ASSET__:bitmap_flixel_system_debug_GraphicArrowLeft","\x07","\x17","\xf4","\x7a");
}
