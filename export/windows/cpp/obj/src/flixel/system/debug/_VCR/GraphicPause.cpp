...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(2078)
	::String tmp4 = ::flixel::_system::debug::_VCR::GraphicPause_obj::resourceName;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(2078)
...
{  hx::ObjectPtr< GraphicPause_obj > _result_ = new GraphicPause_obj();
...
{
	resourceName= HX_HCSTRING("__ASSET__:bitmap_flixel_system_debug__VCR_GraphicPause","\xc8","\x9f","\x12","\x2a");
}
