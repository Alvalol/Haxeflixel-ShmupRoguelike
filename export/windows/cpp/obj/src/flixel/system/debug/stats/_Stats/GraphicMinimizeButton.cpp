...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(2078)
	::String tmp4 = ::flixel::_system::debug::stats::_Stats::GraphicMinimizeButton_obj::resourceName;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(2078)
...
{  hx::ObjectPtr< GraphicMinimizeButton_obj > _result_ = new GraphicMinimizeButton_obj();
...
{
	resourceName= HX_HCSTRING("__ASSET__:bitmap_flixel_system_debug_stats__Stats_GraphicMinimizeButton","\x38","\x20","\x46","\x56");
}
