...
{
HX_STACK_FRAME("flixel.system.debug._VCR.GraphicRecordOff","new",0xb4303408,"flixel.system.debug._VCR.GraphicRecordOff.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
HX_STACK_THIS(this)
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(2078)
	::String tmp4 = ::flixel::_system::debug::_VCR::GraphicRecordOff_obj::resourceName;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(2078)
...
{  hx::ObjectPtr< GraphicRecordOff_obj > _result_ = new GraphicRecordOff_obj();
...
{
	resourceName= HX_HCSTRING("__ASSET__:bitmap_flixel_system_debug__VCR_GraphicRecordOff","\x30","\x1f","\xba","\x3c");
}
