...
{  hx::ObjectPtr< FlxPool_flixel_math_FlxPoint_obj > _result_ = new FlxPool_flixel_math_FlxPoint_obj();
...
hx::Object *FlxPool_flixel_math_FlxPoint_obj::__ToInterface(const hx::type_info &inType) {
	if (inType==typeid( ::flixel::util::IFlxPool_obj)) return operator ::flixel::util::IFlxPool_obj *();
	return super::__ToInterface(inType);
}

FlxPool_flixel_math_FlxPoint_obj::operator ::flixel::util::IFlxPool_obj *()
	{ return new ::flixel::util::IFlxPool_delegate_< FlxPool_flixel_math_FlxPoint_obj >(this); }
::flixel::math::FlxPoint FlxPool_flixel_math_FlxPoint_obj::get( ){
	...
	if ((tmp1)){
		...
		HX_STACK_LINE(34)
		::flixel::math::FlxPoint tmp3 = ::Type_obj::createInstance(tmp2,cpp::ArrayBase_obj::__new());		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(34)
		return tmp3;
	}
	HX_STACK_LINE(36)
	...
	HX_STACK_LINE(36)
	::flixel::math::FlxPoint tmp3 = this->_pool->__get(tmp2).StaticCast< ::flixel::math::FlxPoint >();		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(36)
	return tmp3;
}
...
Void FlxPool_flixel_math_FlxPoint_obj::put( ::flixel::math::FlxPoint obj){
{
		...
		if ((tmp)){
			HX_STACK_LINE(44)
			::flixel::math::FlxPoint tmp1 = obj;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(44)
			...
			if ((tmp7)){
				...
				HX_STACK_LINE(49)
				::flixel::math::FlxPoint tmp9 = obj;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(49)
...
{
		HX_STACK_FRAME("flixel.util.FlxPool_flixel_math_FlxPoint","putUnsafe",0xf57edda4,"flixel.util.FlxPool_flixel_math_FlxPoint.putUnsafe","flixel/util/FlxPool.hx",55,0xdd4de86a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(obj,"obj")
		HX_STACK_LINE(56)
		bool tmp = (obj != null());		HX_STACK_VAR(tmp,"tmp");
		...
		if ((tmp)){
			...
			HX_STACK_LINE(59)
			::flixel::math::FlxPoint tmp2 = obj;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(59)
...
Void FlxPool_flixel_math_FlxPoint_obj::preAllocate( int numObjects){
{
		...
		while((true)){
			...
			HX_STACK_LINE(67)
			::flixel::math::FlxPoint tmp5 = ::Type_obj::createInstance(tmp4,cpp::ArrayBase_obj::__new());		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(67)
...
int FlxPool_flixel_math_FlxPoint_obj::get_length( ){
	HX_STACK_FRAME("flixel.util.FlxPool_flixel_math_FlxPoint","get_length",0xb3eaac80,"flixel.util.FlxPool_flixel_math_FlxPoint.get_length","flixel/util/FlxPool.hx",80,0xdd4de86a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(81)
	int tmp = this->_count;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(81)
...
Dynamic FlxPool_flixel_math_FlxPoint_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic FlxPool_flixel_math_FlxPoint_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
