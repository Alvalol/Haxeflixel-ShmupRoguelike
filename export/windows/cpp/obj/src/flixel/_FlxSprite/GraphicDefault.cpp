...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(2078)
	::String tmp4 = ::flixel::_FlxSprite::GraphicDefault_obj::resourceName;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(2078)
...
{  hx::ObjectPtr< GraphicDefault_obj > _result_ = new GraphicDefault_obj();
...
{
	resourceName= HX_HCSTRING("__ASSET__:bitmap_flixel__FlxSprite_GraphicDefault","\x83","\x56","\xaf","\x06");
}
