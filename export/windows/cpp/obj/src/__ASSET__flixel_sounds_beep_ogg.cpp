...
Dynamic forcePlayAsMusic = __o_forcePlayAsMusic.Default(false);
{
	...
	HX_STACK_LINE(2287)
	::String tmp = ::__ASSET__flixel_sounds_beep_ogg_obj::resourceName;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(2287)
...
{  hx::ObjectPtr< __ASSET__flixel_sounds_beep_ogg_obj > _result_ = new __ASSET__flixel_sounds_beep_ogg_obj();
...
{
	resourceName= HX_HCSTRING("__ASSET__:sound___ASSET__flixel_sounds_beep_ogg","\xac","\xee","\x6e","\x4e");
}
