...
class HXCPP_CLASS_ATTRIBUTES  GL_obj : public hx::Object{
	...
	public:
		...
		static Void bufferData( int target,::openfl::_legacy::utils::IMemoryRange data,int usage);
		static Dynamic bufferData_dyn();

		static Void bufferSubData( int target,int offset,::openfl::_legacy::utils::IMemoryRange data);
		...
		static Void compressedTexImage2D( int target,int level,int internalformat,int width,int height,int border,::openfl::_legacy::utils::IMemoryRange data);
		static Dynamic compressedTexImage2D_dyn();

		static Void compressedTexSubImage2D( int target,int level,int xoffset,int yoffset,int width,int height,int format,::openfl::_legacy::utils::IMemoryRange data);
