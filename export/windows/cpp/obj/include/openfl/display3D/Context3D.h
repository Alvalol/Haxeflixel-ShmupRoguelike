...
class HXCPP_CLASS_ATTRIBUTES  Context3D_obj : public hx::Object{
	...
	public:
		...
		virtual Void setBackBufferViewPort( Dynamic x,Dynamic y,Dynamic width,Dynamic height);
		Dynamic setBackBufferViewPort_dyn();

		virtual Void updateBackBufferViewPort( );
		Dynamic updateBackBufferViewPort_dyn();

		virtual Void updateDepthAndStencilState( );
		...
		virtual ::openfl::display3D::IndexBuffer3D createIndexBuffer( int numIndices,::openfl::display3D::Context3DBufferUsage bufferUsage);
		...
		virtual ::openfl::display3D::VertexBuffer3D createVertexBuffer( int numVertices,int data32PerVertex,::openfl::display3D::Context3DBufferUsage bufferUsage);
		...
		virtual Void updateScissorRectangle( );
