...
class FlxBarFillDirection_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("flixel.ui.FlxBarFillDirection","\x93","\x96","\xf4","\x4c"); }
		::String __ToString() const { return HX_HCSTRING("FlxBarFillDirection.","\xf3","\xc1","\xc0","\x64") + tag; }
