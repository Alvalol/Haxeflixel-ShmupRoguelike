...
class HXCPP_CLASS_ATTRIBUTES  FlxBaseTilemap_obj : public ::flixel::FlxObject_obj{
	...
	public:
		...
		virtual Array< ::Dynamic > findPath( ::flixel::math::FlxPoint Start,::flixel::math::FlxPoint End,hx::Null< bool >  Simplify,hx::Null< bool >  RaySimplify,hx::Null< int >  DiagonalPolicy);
		Dynamic findPath_dyn();

		virtual Array< int > computePathDistance( int StartIndex,int EndIndex,int DiagonalPolicy,hx::Null< bool >  StopOnEnd);
