...
class HXCPP_CLASS_ATTRIBUTES  FlxTypedEmitter_obj : public ::flixel::group::FlxTypedGroup_obj{
	...
	public:
		...
		virtual Dynamic loadParticle( Dynamic Graphics,int Quantity,int bakedRotationAngles,hx::Null< bool >  Multiple,hx::Null< bool >  AutoBuffer,int totalFrames);
		...
		virtual Void emitContinuously( Float elapsed);
		Dynamic emitContinuously_dyn();

		virtual Void emitParticleContinuously( );
