...
class HXCPP_CLASS_ATTRIBUTES  FlxAnimationController_obj : public hx::Object{
	...
	public:
		...
		virtual Void add( ::String Name,Array< int > Frames,hx::Null< int >  FrameRate,hx::Null< bool >  Looped,hx::Null< bool >  FlipX,hx::Null< bool >  FlipY);
		Dynamic add_dyn();
		...
		virtual Void addByNames( ::String Name,Array< ::String > FrameNames,hx::Null< int >  FrameRate,hx::Null< bool >  Looped,hx::Null< bool >  FlipX,hx::Null< bool >  FlipY);
		Dynamic addByNames_dyn();

		virtual Void appendByNames( ::String Name,Array< ::String > FrameNames);
		Dynamic appendByNames_dyn();

		virtual Void addByStringIndices( ::String Name,::String Prefix,Array< ::String > Indices,::String Postfix,hx::Null< int >  FrameRate,hx::Null< bool >  Looped,hx::Null< bool >  FlipX,hx::Null< bool >  FlipY);
		...
		virtual Void addByIndices( ::String Name,::String Prefix,Array< int > Indices,::String Postfix,hx::Null< int >  FrameRate,hx::Null< bool >  Looped,hx::Null< bool >  FlipX,hx::Null< bool >  FlipY);
		...
		virtual Void addByPrefix( ::String Name,::String Prefix,hx::Null< int >  FrameRate,hx::Null< bool >  Looped,hx::Null< bool >  FlipX,hx::Null< bool >  FlipY);
