...
#endif
HX_DECLARE_CLASS4(flixel,_system,debug,_VCR,GraphicRestart)
...
class HXCPP_CLASS_ATTRIBUTES  GraphicRestart_obj : public ::openfl::_legacy::display::BitmapData_obj{
	public:
