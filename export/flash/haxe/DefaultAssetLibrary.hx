...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/enemies.png", __ASSET__assets_images_enemies_png);
		...
		className.set ("assets/images/items.png", __ASSET__assets_images_items_png);
		type.set ("assets/images/items.png", AssetType.IMAGE);
		className.set ("assets/images/mockups.pyxel", __ASSET__assets_images_mockups_pyxel);
		type.set ("assets/images/mockups.pyxel", AssetType.BINARY);
		className.set ("assets/images/nohit.png", __ASSET__assets_images_nohit_png);
		...
		className.set ("assets/images/playerDawnbringer.pyxel", __ASSET__assets_images_playerdawnbringer_pyxel);
		type.set ("assets/images/playerDawnbringer.pyxel", AssetType.BINARY);
		className.set ("assets/images/playerWip.pyxel", __ASSET__assets_images_playerwip_pyxel);
		type.set ("assets/images/playerWip.pyxel", AssetType.BINARY);
		className.set ("assets/images/solid.png", __ASSET__assets_images_solid_png);
		type.set ("assets/images/solid.png", AssetType.IMAGE);
		className.set ("assets/images/solidtiles.pyxel", __ASSET__assets_images_solidtiles_pyxel);
		type.set ("assets/images/solidtiles.pyxel", AssetType.TEXT);
		className.set ("assets/images/sys/cursor.png", __ASSET__assets_images_sys_cursor_png);
		...
		className.set ("assets/images/tiles.png_palette.png", __ASSET__assets_images_tiles_png_palette_png);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_pixel_font_ttf extends flash.text.Font { }
@:keep @:bind #if display private #end class __ASSET__assets_data_sandbox_tmx extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_images_enemies_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_items_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_mockups_pyxel extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_images_nohit_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_player_pyxel extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_images_playerdawnbringer_pyxel extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_images_playerwip_pyxel extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_images_solid_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_solidtiles_pyxel extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_images_sys_cursor_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_tiles_png_palette_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_turret_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/images/enemies.png") #if display private #end class __ASSET__assets_images_enemies_png extends lime.graphics.Image {}
...
@:image("assets/images/items.png") #if display private #end class __ASSET__assets_images_items_png extends lime.graphics.Image {}
@:file("assets/images/mockups.pyxel") #if display private #end class __ASSET__assets_images_mockups_pyxel extends lime.utils.Bytes {}
@:image("assets/images/nohit.png") #if display private #end class __ASSET__assets_images_nohit_png extends lime.graphics.Image {}
...
@:file("assets/images/player.pyxel") #if display private #end class __ASSET__assets_images_player_pyxel extends lime.utils.Bytes {}
@:file("assets/images/playerDawnbringer.pyxel") #if display private #end class __ASSET__assets_images_playerdawnbringer_pyxel extends lime.utils.Bytes {}
@:file("assets/images/playerWip.pyxel") #if display private #end class __ASSET__assets_images_playerwip_pyxel extends lime.utils.Bytes {}
@:image("assets/images/solid.png") #if display private #end class __ASSET__assets_images_solid_png extends lime.graphics.Image {}
@:file("assets/images/solidtiles.pyxel") #if display private #end class __ASSET__assets_images_solidtiles_pyxel extends lime.utils.Bytes {}
@:image("assets/images/sys/cursor.png") #if display private #end class __ASSET__assets_images_sys_cursor_png extends lime.graphics.Image {}
@:image("assets/images/tiles.png") #if display private #end class __ASSET__assets_images_tiles_png extends lime.graphics.Image {}
@:image("assets/images/tiles.png_palette.png") #if display private #end class __ASSET__assets_images_tiles_png_palette_png extends lime.graphics.Image {}
@:image("assets/images/turret.png") #if display private #end class __ASSET__assets_images_turret_png extends lime.graphics.Image {}
