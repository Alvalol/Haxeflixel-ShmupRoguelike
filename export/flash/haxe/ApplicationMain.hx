...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/images/enemies.png");
		...
		urls.push ("assets/images/items.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/mockups.pyxel");
		types.push (lime.Assets.AssetType.BINARY);
		
		
		urls.push ("assets/images/nohit.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/images/playerDawnbringer.pyxel");
		types.push (lime.Assets.AssetType.BINARY);
		
		
		urls.push ("assets/images/playerWip.pyxel");
		types.push (lime.Assets.AssetType.BINARY);
		...
		urls.push ("assets/images/sys/cursor.png");
		types.push (lime.Assets.AssetType.IMAGE);
